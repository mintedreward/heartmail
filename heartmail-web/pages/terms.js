...
export default function Terms () {
  return (
    <Layout title='Terms of Service'>
      ...
      <p>If you give people an affiliate link then you are an affiliate. Affiliates must continue to help the people they onboard sign in and use the service or we have the right to terminate the affiliate relationship.</p>
