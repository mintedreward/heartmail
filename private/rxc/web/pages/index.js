  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <p>Imagine you provide a service like a hosted Bitcoin wallet. You take every precaution to secure your users' funds. Unfortunately, one day your service is hacked, and your users' funds are stolen.</p>
        ...
        <p><a href="https://www.arsov.bg/">Kris Arsov</a>. I'm a Salesforce Commerce Cloud Engineer at 5 PM Ltd.</p>

        <p><a href="https://tyeverett.com/">Ty Everett</a>. An unquestioned answer is far worse than an unanswered question.</p>
