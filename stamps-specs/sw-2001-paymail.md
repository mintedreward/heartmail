...
the next protocol specification, SW 2.

Many SW protocols are extensions to paymail. In this initial protocol, we
simply copy the original paymail protocol spec into the SW, with some minor
...
"SW-[number]-[name]" exactly like the filename of the spec in the repo. This
will never create a naming conflict because we are using the "SW-" namespace.
...
is to say, from Day 1 of the launch of SW / OpenSPV, all transactions are sent
...
![Service Discovery](./SW-2001-service-discovery.png)
