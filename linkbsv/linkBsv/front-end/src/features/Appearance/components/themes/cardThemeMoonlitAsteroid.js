...
const Card = (props)=>{
    return (
        <div
          onClick={()=>props.onSelect("moonLitAsteroid")}
          className="p-3" 
          style={{
            cursor:'pointer',
            borderRadius:'14px',
            ...
            <div className="header text-center pb-3">
                <h3 style={{fontSize:'16px',fontWeight:'600',color:'rgba(0,0,0,0.8)'}}>Moonlit Asteroid</h3>
            </div>
            <div 
            className="pl-4 pr-4 pt-5 pb-5"
            style={{borderRadius:'14px',... themeStyles.moonLitAsteroid}}
            >
            <div className="pb-2">
                <Rect/>
            </div>
