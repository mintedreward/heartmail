...
describe('Bn', () => {
  ...
  it.skip('should correctly square the number related to a bug in bn.js', function () {
    /**
  ...
  it('should correctly square these numbers related to a bug in OpenSSL - CVE-2014-3570', function () {
     ...
     */
    const p = Bn.fromHex('115792089237316195423570985008687907853269984665640564039457584007908834671663')
  ...
  describe('#toBuffer', () => {
    ...
    it.skip('should create a 2 byte buffer even if you ask for a 1 byte', function () {
