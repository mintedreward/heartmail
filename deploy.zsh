...
ssh -t coasian-web-1 "docker run -p 80:3000 ryanxcharles/coasian-web:${version} &>/dev/null &"
ssh -t coasian-web-2 'docker kill $(docker ps -q)'
ssh -t coasian-web-2 'docker rm $(docker ps -a -q)'
ssh -t coasian-web-2 "docker run -p 80:3000 ryanxcharles/coasian-web:${version} &>/dev/null &"
...
ssh -t openspv-web-1 "docker run -p 80:3000 ryanxcharles/openspv-web:${version} &>/dev/null &"
ssh -t openspv-web-2 'docker kill $(docker ps -q)'
ssh -t openspv-web-2 'docker rm $(docker ps -a -q)'
ssh -t openspv-web-2 "docker run -p 80:3000 ryanxcharles/openspv-web:${version} &>/dev/null &"
