...
ssh -t coasian-web-1 'docker login --username $DOCKER_USERNAME --password $DOCKER_PASSWORD'
...
ssh -t coasian-web-2 'docker login --username $DOCKER_USERNAME --password $DOCKER_PASSWORD'
